...
<body>
    ...
    ?>
    <main class="mmadm">
    <p  style="font-size: 12px;">©<span id="year"></span> Copyright. All rights reserved</p>
    <script>
        ...
        <div  class="">
            <div class="">
                <div class="">
                 ...
                 <!-- music list  -->
                    <div class="mlist__">
                        <div class="">
                            <div class="added">
                                <h5 class="">My Special Playlist</h5>
                                <div class="">
                                    <button class="add_new_music" data-bs-toggle="modal" data-bs-target="#music_modal" type="button"><i class="fa fa-plus"></i> Add New Music</button>
                                </div>
                            </div>
                        </div>
                        <div class="m_begi">
                ...
                <div class="down_play">
                        <div class="dimg">
                            <img src="../H_IMGAES/logo1.png" alt="" id="display-img" class="" >
                            <div class="disk">
        ...
        <div class="modal" id="music_modal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-md">
                    ...
                    <div class="container-fluid">
                        <form action="" id="music-form">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control form-control-sm rounded-0" required placeholder="Song Name">
                            </div>
                            <div class="form-group mb-3">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-sm rounded-0" style="padding:10px 14px;" form="music-form">Add New Song</button>
                </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal text-dark" id="update_music_modal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-md">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-sm rounded-0" form="update-music-form" style="padding: 10px 14px;">Update Music</button>
                </div>
                </div>
            </div>
        </div>
